...
def create_supervisor_agent(actor_id: str, session_id: str) -> Agent:
...
def run_prompt(prompt: str, actor_id: str, session_id: str) -> str:
...
def main() -> int:
    ...
    configure_logging()
    print(run_prompt(args.prompt, args.actor_id, args.session_id))
    return 0
