...
IMAGE_TAG="lab04-$(date -u +%Y%m%d%H%M%S)"
...
SERVICE_MANIFEST="$(mktemp "${TMPDIR:-/tmp}/mortgage-memory-service.XXXXXX.yaml")"
...
echo
echo "Mortgage assistant memory smoke-test response:"
